  ...
  return (
    ...
    <div className="mt-[105px] ">
      <div className="container flex flex-wrap gap-[30px] gap-y-[65px] pb-[100px]">
        {jobs.map(job=>(
           <div className="job cursor-pointer relative flex flex-col justify-between bg-white w-[350px] h-[228px] pt-[49px] rounded-md px-8 pb-9">
             <div className="absolute -top-[26px] w-[50px] h-[50px] rounded-[15px] bg-[#938e8e7c] flex items-center justify-center">
               <img src={`https://frontend-mentor-apis-6efy.onrender.com${job.logo}`} alt="" />            
             </div> 
            <div>
             ...
             <h3 className="text-[#19202D] text-xl font-bold mb-3">{job.position}</h3>
